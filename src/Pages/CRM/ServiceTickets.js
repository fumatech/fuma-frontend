...
const ServiceTickets = () => {
  ...
  const handleStatusChange = async (status) => {
    try {
      const loggedInEmail = sessionStorage.getItem("userEmail");
      const comment = prompt("Optional: Add a comment for this status change");
      await serviceTicketService.updateStatus(currentTicket.id, status, comment, loggedInEmail);
                ...
                <div className="modal-body p-4">
                  <div className="row g-3">
                    <div className="col-12">
                      <label className="form-label fw-bold small text-uppercase">Customer (Franchise)</label>
              ...
              <div className="modal-body p-0" style={{ maxHeight: '85vh', overflowY: 'auto' }}>
                <div className="row g-0">
                  ...
                  <div className="col-md-4 border-end bg-light p-4">
                    ...
                    <div className="mb-3">
                      <label className="d-block small text-muted">Customer</label>
                      <div className="fw-bold">{getCustomerName(currentTicket.customerId)}</div>
                    </div>
                    <div className="mb-3">
                      <label className="d-block small text-muted">Created By</label>
                      <div>{currentTicket.createdBy}</div>
                    </div>
                    <div className="mb-3">
                      <label className="d-block small text-muted">Created Date</label>
                    ...
                    <div className="mb-3">
                      <label className="d-block small text-muted mb-1">Assigned To</label>
                      <select 
                    ...
                    <div className="mb-4">
                      <label className="d-block small text-muted mb-1">Quick Status Update</label>
                      <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-sm btn-outline-primary" onClick={() => handleStatusChange("IN_PROGRESS")}>Start</button>
                        <button className="btn btn-sm btn-outline-success" onClick={() => handleStatusChange("RESOLVED")}>Resolve</button>
                        <button className="btn btn-sm btn-outline-dark" onClick={() => handleStatusChange("CLOSED")}>Close</button>
                      </div>
                    </div>
                  </div>
