...
function ViewPurchaseOrder() {
  ...
  const [totalShippedItems, setTotalShippedItems] = useState(0); // New state for total units
                      ...
                      <div className="col-md-12">
                        ...
                        {selectedProducts.length > 0 && (
                          <div className="table-responsive">
                            ...
                            <div>Total Purchase units : {totalUnits}</div>
                            <div>Total Shipped units : {totalShippedItems}</div>
                          </div>
                        )}
                      </div>
                    </div>
