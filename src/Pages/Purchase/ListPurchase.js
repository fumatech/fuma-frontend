...
const ListPurchase = () => {
    ...
    const fetchPurchases = async () => {
      try {
        const response = await fetch(
          `${process.env.REACT_APP_BASE_URL}/purchase/getall`
        );
        if (!response.ok) {
  ...
  const handleDeleteClick = (id) => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      fetch(`${process.env.REACT_APP_BASE_URL}/purchase/delete/${id}`, {
        method: "DELETE",
      })
        .then((response) => {
          ...
          <table>
            <thead>
              <tr>
                ...
                ${columnsVisibility.status ? "<th>Purchase Status</th>" : ""}
                ${
                ...
                ${
                  columnsVisibility.netTotalAmount ? "<th>Grand Total</th>" : ""
                }
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-12 col-md-6">
                <h1 className=" all-heading">Purchases</h1>
          ...
          <div className="container-fluid">
            <div className="card cardHover rounded-4 border-0">
              <div className="d-flex justify-content-end mb-3">
                <Link to="/AddPurchase" className="btn btn-add">
