...
import EmployeeMyAttendance from "../EmployeePortal/EmployeeMyAttendance";

const EmployeeAttendanceView = ({ embedded = false }) => {
    ...
    const content = (
        <div>
            ...
            {!loading && selectedEmployee ? (
                <EmployeeMyAttendance employee={selectedEmployee} />
            ) : (
                <div className="card">
                    <div className="card-body text-center text-muted py-4">
                        {loading ? "Loading employees..." : "Select an employee to view attendance."}
                    </div>
                </div>
            )}
        </div>
